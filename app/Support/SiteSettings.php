...
class SiteSettings
{
    ...
    public static function all(): array
    {
        $defaults = [
            ...
            'service_price_direct_image_printing' => (string) (config('printbuka_services.services.direct-image-printing.default_price', 2500)),
            'service_price_direct_image_printing_design' => '0',
            'service_price_direct_image_printing_delivery' => '0',
            'service_price_uv_dtf' => (string) (config('printbuka_services.services.uv-dtf.default_price', 3500)),
            'service_price_dtf' => (string) (config('printbuka_services.services.dtf.default_price', 3000)),
            'service_price_dtf_design' => '0',
            'service_price_dtf_delivery' => '0',
            'service_dtf_size_price_options' => self::pricedLines(['A2', 'A3', 'A4', 'A5', 'A6']),
            'service_price_laser_engraving' => (string) (config('printbuka_services.services.laser-engraving.default_price', 5000)),
