                ...
                <div className="row g-4 align-items-center">
                    <div className="col-lg-6">
                        <div className="hero-content">
                            <h6 className="wow fadeInUp">Nigeria&apos;s #1 Online Print Shop</h6>
                            <h1 className="wow fadeInUp" data-wow-delay=".3s">
                                Print. Brand.
                                <span>Gift. <img src={Shape6} alt="img" /></span> Delivered.
                            </h1>
                            <p className="wow fadeInUp" data-wow-delay=".5s">
                                Business cards, flyers, branded gifts, UV-DTF, DTF and laser <br />
                                engraving — shipped to all 36 states in 3–7 days.
                            </p>
                            <ul className="list wow fadeInUp" data-wow-delay=".7s">
                                ...
                                <li>
                                    <i className="fa-sharp fa-solid fa-check"></i>
                                    Fast 24-hour file review &amp; free artwork check
                                </li>
                            </ul>
                            <Link to="/shop" onClick={ClickHandler} className="theme-btn wow fadeInUp" data-wow-delay=".9s">Shop Now</Link>
                        </div>
                    </div>
