                        ...
                        <div className="col-xl-3 col-sm-6 col-md-6 col-lg-4" >
                            <div className="single-footer-widget">
                                ...
                                <div className="footer-content">
                                    <p>
                                        Nigeria's #1 online print shop — business cards, flyers,
                                        branded gifts, UV-DTF, DTF &amp; laser engraving. Delivered nationwide.
                                    </p>
                                    <ul className="contact-list">
                                        ...
                                        <li>
                                            ...
                                            <a onClick={ClickHandler} href="mailto:info@printbuka.com" className="link">info@printbuka.com</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div className="footer-bottom">
                    ...
                    <div className="footer-wrapper d-flex align-items-center justify-content-between">
                        <p className="fadeInLeft color-2" >
                            Copyright <span>@2025</span> <Link onClick={ClickHandler} to="/">Printbuka</Link>. All Rights Reserved
                        </p>
