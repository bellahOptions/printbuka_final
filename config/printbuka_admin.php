...
return [
    'roles' => [
        ...
        'production_manager' => ['admin.view', 'orders.view', 'orders.phase_comment', 'workflow.approve', 'sop.verify', 'production.update', 'qc.update', 'packaging.update', 'delivery.update', 'large_format.manage', 'large_format.calculate', 'inventory.view', 'inventory.manage', 'attendance.manage', 'vendors.view'],
        'customer_service'   => ['admin.view', 'orders.view', 'orders.create', 'orders.intake', 'invoices.manage', 'delivery.update', 'client_review.update', 'sop.update', 'newsletters.manage', 'customers.manage', 'finance.view', 'finance.view_amounts', 'shop-orders.view', 'pricelist.manage', 'large_format.calculate', 'vendors.view', 'vendors.manage', 'inventory.view', 'inventory.manage'],
        ...
        'social_media_manager' => ['admin.view', 'blog.view', 'blog.manage', 'advertisements.manage'],
        'staff_pending'      => [],
    ],
    ...
    'staff_dashboard_menus' => [
        ...
        'production_manager' => ['Production Jobs', 'QC & Packaging', 'Phase Approvals', "Today's Tasks"],
        ...
        'social_media_manager' => ['Blog', 'Advertisements', "Today's Tasks"],
    ...
    'module_permissions' => [
        ...
        'advertisements.manage' => 'Advertisement Management',
