...
return [
    'roles' => [
        ...
        'customer_service' => ['admin.view', 'orders.view', 'orders.create', 'orders.intake', 'invoices.manage', 'delivery.update', 'client_review.update', 'sop.update', 'newsletters.manage', 'customers.manage', 'finance.view', 'finance.create', 'finance.update', 'finance.delete', 'finance.view_amounts' ],
