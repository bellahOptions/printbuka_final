...
return [
    'roles' => [
        ...
        'customer_service' => ['admin.view', 'orders.view', 'orders.create', 'orders.intake', 'invoices.manage', 'delivery.update', 'client_review.update', 'sop.update', 'newsletters.manage', 'customers.manage'],
        'marketing' => ['admin.view', 'newsletters.manage'],
        'designer' => ['admin.view', 'orders.view', 'design.update', 'design.upload'],
        'graphic_designer' => ['admin.view', 'orders.view', 'design.update', 'design.upload'],
        'creative_designer' => ['admin.view', 'orders.view', 'design.update', 'design.upload'],
        ...
        'production_assistant' => ['admin.view', 'orders.view', 'production.update', 'packaging.update'],
    ...
    'staff_dashboard_menus' => [
        ...
        'managing_director' => ['All Data', 'Staff Approvals', 'Jobs', 'Invoices', 'Finance', 'Settings'],
        ...
        'customer_service' => ['Customer Data', 'Job Information', 'Invoices', 'Job Cards', "Today's Tasks"],
        ...
        'qc' => ['Job Information', 'Client Delivery Details', 'Final Design Review', 'Delivery/Return Status', "Today's Tasks"],
        'finance' => ['Invoices', 'Job Information', 'Finance Operations', 'Payment Records', "Today's Tasks"],
        'production' => ['Production Jobs', 'Packaging', "Today's Tasks"],
        'operator' => ['Production Jobs', 'Packaging', "Today's Tasks"],
    ],
