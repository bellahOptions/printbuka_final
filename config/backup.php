...
return [
     ...
     */
    'notifications' => [
        // Only the "something needs attention" events mail out by default —
        // a mail transport hiccup on every routine successful backup is
        // exactly the kind of noise (and failure-to-send crash risk) this
        // avoids. Success/healthy events are still recorded in the
        // system_backups table for the admin UI either way.
        'notifications' => [
