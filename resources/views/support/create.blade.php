...
<main class="min-h-screen bg-gradient-to-br from-slate-50 to-white py-12">
    <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <h1 class="pb-display text-3xl">Create Support Ticket</h1>
            ...
            <div class="card-body p-6 sm:p-8">
                <form action="{{ route('support.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="form-control w-full">
                        ...
                        @error('subject') <span class="text-xs text-brand-600 mt-1">{{ $message }}</span> @enderror
                    </div>
                    ...
                    <div class="grid gap-5 sm:grid-cols-2">
                        <div class="form-control w-full">
                            ...
                            @error('category') <span class="text-xs text-brand-600 mt-1">{{ $message }}</span> @enderror
                        </div>
                        ...
                        <div class="form-control w-full">
                            ...
                            @error('priority') <span class="text-xs text-brand-600 mt-1">{{ $message }}</span> @enderror
                        </div>
                    </div>
                    ...
                    <div class="form-control w-full">
                        ...
                        @error('message') <span class="text-xs text-brand-600 mt-1">{{ $message }}</span> @enderror
                        <label class="label">
                    ...
                    <div class="flex flex-wrap gap-3 justify-end pt-4">
                        <a href="{{ route('support.index') }}" class="pb-cta-outline">
                            Cancel
                        </a>
                        <button type="submit" class="pb-cta-primary">
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="mt-8 grid gap-4 sm:grid-cols-3">
            <div class="text-center p-4">
                <div class="h-10 w-10 mx-auto bg-brand-100 rounded-full flex items-center justify-center mb-2">
