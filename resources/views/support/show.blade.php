    ...
    <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center gap-2 text-sm text-slate-500 mb-2">
                <a href="{{ route('support.index') }}" class="hover:text-brand-600 transition flex items-center gap-1">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h1 class="pb-display text-2xl">{{ $ticket->subject }}</h1>
        ...
        <div class="grid gap-8 lg:grid-cols-3">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="card bg-white rounded-2xl shadow-md border border-slate-100">
                    <div class="card-body p-6">
                        <div class="flex items-start gap-4">
                            <div class="h-10 w-10 rounded-full bg-brand-100 flex items-center justify-center shrink-0">
                ...
                @foreach ($replies as $reply)
                    <div class="card bg-white rounded-2xl shadow-md border border-slate-100 {{ $reply->is_staff_reply ? 'border-l-4 border-l-brand-500' : '' }}">
                        <div class="card-body p-6">
                            <div class="flex items-start gap-4">
                                <div class="h-10 w-10 rounded-full {{ $reply->is_staff_reply ? 'bg-brand-600' : 'bg-slate-200' }} flex items-center justify-center shrink-0">
                                ...
                                <div class="flex-1">
                                    <div class="flex flex-wrap items-center justify-between gap-2 mb-2">
                                        ...
                                        @if($reply->is_staff_reply)
                                            <div class="badge badge-sm bg-brand-100 text-brand-700">Staff Response</div>
                                        @endif
                                    </div>
                                    <div class="prose prose-sm max-w-none text-slate-700 whitespace-pre-wrap">
                                        {{ $reply->message }}
                        ...
                        <div class="card-body p-6">
                            ...
                            <form action="{{ route('support.reply', $ticket) }}" method="POST">
                                ...
                                <div class="flex justify-end mt-4">
                                    <button type="submit" class="btn bg-brand-600 hover:bg-brand-700 border-0 text-white">
            ...
            <div class="space-y-6">
                ...
                {{-- Need Help? Card --}}
                <div class="card bg-gradient-to-r from-brand-50 to-cyan-50 rounded-2xl border border-brand-100">
                    <div class="card-body p-6">
