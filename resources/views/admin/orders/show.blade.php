...
@section('content')
    ...
    <main class="bg-slate-50 py-12 text-slate-900">
        <section class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <form action="{{ route('admin.orders.update', $order) }}" method="POST" class="mt-8 grid gap-8 lg:grid-cols-[1.15fr_0.85fr]">
                @csrf
                @method('PUT')
