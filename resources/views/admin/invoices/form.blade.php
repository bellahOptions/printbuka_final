    ...
    <div class="mx-auto max-w-6xl space-y-6">
        <div class="fade-in-up rounded-2xl bg-gradient-to-br from-slate-900 via-slate-900 to-slate-800 p-8 text-white shadow-xl">
            ...
            <div class="flex items-start gap-4">
                <div class="flex-1">
                    <h1 class="text-4xl font-black tracking-tight lg:text-5xl">Edit {{ strtolower($invoice->documentTypeLabel()) }}</h1>
                    <p class="mt-3 max-w-3xl text-base leading-relaxed text-slate-300">
                        Modify the invoice, its items, or customer details.
                    </p>
                </div>
            ...
            <div class="rounded-2xl border border-slate-200/60 bg-white p-6 shadow-sm lg:p-8">
                <div class="grid gap-5 sm:grid-cols-2">
                    ...
                    <div class="space-y-1">
                        ...
                        <input id="invoice-customer-phone" name="customer_phone" value="{{ old('customer_phone', $order->customer_phone) }}" required class="w-full rounded-xl border border-slate-300 bg-white px-4 py-3.5 text-sm font-semibold text-slate-800 placeholder-slate-400 transition-all duration-300 focus:border-pink-500 focus:ring-2 focus:ring-pink-500/20" placeholder="+234 XXX XXX XXXX">
            ...
            <div class="rounded-2xl border border-slate-200/60 bg-white p-6 shadow-sm lg:p-8">
                ...
                <div class="catalog-item-grid grid grid-cols-2 gap-4 sm:gap-5 sm:grid-cols-2">
                    ...
                    <div class="catalog-item-field catalog-item-field--quantity space-y-1">
                        ...
                        <input id="catalog-quantity" type="number" min="1" name="quantity" value="{{ $defaultQuantity }}" required class="w-full rounded-xl border border-slate-300 bg-white px-4 py-3.5 text-sm font-semibold text-slate-800 transition-all duration-300 focus:border-pink-500 focus:ring-2 focus:ring-pink-500/20">
                    ...
                    <div class="catalog-item-field space-y-1">
                        ...
                        <input id="catalog-tax" type="number" step="0.01" min="0" name="tax_amount" value="{{ $defaultTax }}" class="w-full rounded-xl border border-slate-300 bg-white px-4 py-3.5 text-sm font-semibold text-slate-800 transition-all duration-300 focus:border-pink-500 focus:ring-2 focus:ring-pink-500/20" placeholder="0.00">
                    ...
                    <div class="catalog-item-field space-y-1">
                        ...
                        <input id="catalog-discount" type="number" step="0.01" min="0" name="discount_amount" value="{{ $defaultDiscount }}" class="w-full rounded-xl border border-slate-300 bg-white px-4 py-3.5 text-sm font-semibold text-slate-800 transition-all duration-300 focus:border-pink-500 focus:ring-2 focus:ring-pink-500/20" placeholder="0.00">
                ...
                <div class="mt-6 rounded-xl border border-slate-200">
                    <div class="border-b border-slate-200 bg-slate-50 px-4 py-3">
                        <p class="text-sm font-black text-slate-900">Editable Invoice Items</p>
            ...
            <div class="rounded-2xl border border-slate-200/60 bg-white p-6 shadow-sm lg:p-8">
                <div class="grid gap-5 sm:grid-cols-2">
                    <div class="space-y-1">
                        ...
                        <input type="datetime-local" name="due_at" value="{{ $defaultDueAt }}" class="w-full rounded-xl border border-slate-300 bg-white px-4 py-3.5 text-sm font-semibold text-slate-800 transition-all duration-300 focus:border-pink-500 focus:ring-2 focus:ring-pink-500/20">
        ...
        (() => {
            ...
            addLineItemButton?.addEventListener('click', () => {
                ...
                row.innerHTML = `
                    ...
                    <td class="px-4 py-3"><input type="number" min="1" step="1" value="1" data-line-item-quantity class="w-24 rounded-lg border border-slate-300 px-3 py-2 text-sm font-semibold text-slate-800"></td>
                    <td class="px-4 py-3"><input type="number" min="0" step="0.01" value="0" data-line-item-rate class="w-32 rounded-lg border border-slate-300 px-3 py-2 text-sm font-semibold text-slate-800"></td>
                    <td class="px-4 py-3 font-black text-slate-900" data-line-item-amount>₦0.00</td>
                    <td class="px-4 py-3 text-right"><button type="button" data-remove-line-item class="rounded-lg border border-slate-200 px-3 py-2 text-xs font-black uppercase tracking-wide text-slate-500 hover:border-red-200 hover:text-red-600">Remove</button></td>
                `;
