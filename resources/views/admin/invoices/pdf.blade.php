...
<head>
    ...
    @php
        ...
        $companyAccountName = trim((string) ($payToAccount?->account_name ?? $settings['company_account_name'] ?? '')) ?: 'Alet Inspirationz';
        $companyAccountNumber = trim((string) ($payToAccount?->account_number ?? $settings['company_account_number'] ?? '')) ?: '0062999338';
        $companyAccountBankName = trim((string) ($payToAccount?->bank_name ?? $settings['company_account_bank_name'] ?? '')) ?: 'Access bank';
...
<body>
    <div class="wrap">
        ...
        {{-- Bottom: Sender details (left) + Payment info (right) --}}
