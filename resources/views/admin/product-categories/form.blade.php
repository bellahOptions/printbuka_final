    ...
    <div class="mx-auto max-w-5xl">
            ...
            <form action="{{ $category->exists ? route('admin.product-categories.update', $category) : route('admin.product-categories.store') }}" method="POST" class="mt-8 rounded-md border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <div class="grid gap-5 sm:grid-cols-2">
                    ...
                    <label class="text-sm font-black sm:col-span-2">Description<textarea name="description" rows="5" data-rich-editor class="mt-2 w-full rounded-md border border-slate-200 px-4 py-3 font-semibold">{{ old('description', $category->description) }}</textarea></label>
