...
@section('title', 'Dashboard | Printbuka')
        ...
        <section class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col gap-5 rounded-md bg-slate-950 p-6 text-white sm:flex-row sm:items-center sm:justify-between lg:p-8">
                <div>
                    ...
                    <h1 class="mt-2 text-4xl">Welcome, {{ auth()->user()->name }}.</h1>
            ...
            <div class="mt-8 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
                <div class="rounded-md border border-slate-200 bg-white p-6 shadow-sm">
                    ...
                    <p class="mt-3 text-5xl font-black text-slate-950">{{ $productCount }}</p>
                ...
                <div class="rounded-md border border-slate-200 bg-white p-6 shadow-sm">
                    ...
                    <p class="mt-3 text-5xl font-black text-slate-950">{{ $orderCount }}</p>
            ...
            <div class="mt-8 grid gap-8 lg:grid-cols-[1.2fr_0.8fr]">
                <section class="rounded-md border border-slate-200 bg-white p-6 shadow-sm">
                    <div class="flex items-center justify-between gap-4">
                        <div>
                            <p class="text-sm font-black uppercase tracking-wide text-pink-700">Recent Products</p>
                            <h2 class="mt-2 text-3xl text-slate-950">Ready to order.</h2>
                        </div>
                        <a href="{{ route('products.index') }}" class="rounded-md border border-slate-200 px-4 py-3 text-sm font-black text-slate-800 transition hover:border-pink-300 hover:text-pink-700">All Products</a>
                    </div>
                    ...
                    <div class="mt-6 space-y-4">
                        ...
                        @empty
                            <p class="rounded-md border border-dashed border-slate-300 p-5 text-sm text-slate-600">No products yet. Seed products to populate this area.</p>
                        @endforelse
                    </div>
                </section>
                ...
                <aside class="rounded-md border border-slate-200 bg-white p-6 shadow-sm">
                    ...
                    <div class="mt-5 space-y-3">
                        ...
                        <a href="#" class="block rounded-md border border-slate-200 px-5 py-4 text-sm font-black text-slate-800 transition hover:border-emerald-300 hover:text-emerald-700">Request a Quote</a>
                    </div>
                </aside>
            </div>
        </section>
