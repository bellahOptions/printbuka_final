...
@section('content')
    <main role="main">
        ...
        <section class="relative overflow-hidden min-h-[640px]">
            ...
            @foreach($heroSlides as $i => $slide)
                <div class="hero-slide absolute inset-0 transition-opacity duration-1000 {{ $i === 0 ? 'opacity-100' : 'opacity-0' }}">
                    ...
                    {{-- Brand overlay --}}
                    <div class="absolute inset-0 bg-gradient-to-br from-brand-800/90 via-brand-700/85 to-slate-950/80"></div>
                </div>
            @endforeach
            ...
            <div class="relative z-10 flex items-center justify-center min-h-[640px]">
                <div class="md:w-[70%] w-[90%] mx-auto px-4 sm:px-6 lg:px-8 py-20 flex flex-col items-center text-center">
                    <span class="pb-eyebrow mb-4 text-white/80">
                        <x-heroicon-s-sparkles class="h-3.5 w-3.5" aria-hidden="true" />
                        Nigeria's No. 1 Online Print Shop
                    </span>
                    <h1 class="text-4xl sm:text-5xl xl:text-6xl font-black text-white leading-[1.1] mb-5">
                        The Leader in Quality<br>
                        <span class="pb-display-italic text-white">Custom Print Design</span>
                    </h1>
        ...
        {{-- Clients --}}
        <section class="pb-section-tight overflow-hidden">
            <div class="text-center mb-8">
                <p class="pb-eyebrow mb-2">Trusted Partners</p>
                <h2 class="text-3xl font-bold text-slate-950">Trusted by Leading Brands</h2>
            </div>
        ...
        {{-- Featured Products --}}
        <section class="pb-section px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-10">
                <p class="pb-eyebrow mb-2">Handpicked For You</p>
                <h2 class="pb-display text-3xl sm:text-4xl">Featured Products</h2>
            </div>
                            ...
                            <div class="fp-slide group relative flex-shrink-0 rounded-2xl overflow-hidden w-[calc(25%_-_18px)] h-[340px]">
                                ...
                                @if($product->category)
                                    <div class="absolute top-4 left-4">
                                        <span
                                            class="bg-brand-600 text-white text-[10px] font-black uppercase tracking-widest px-2.5 py-1 rounded-full">
                                ...
                                <div
                                    ...
                                    @if($product->hasAvailablePrice())
                                        <p class="text-brand-300 text-sm font-bold mt-1">from NGN
                                ...
                                <div
                                    ...
                                    <div class="flex items-center justify-between gap-3">
                                        @if($product->hasAvailablePrice())
                                            <span class="text-base font-black text-brand-600">NGN
                                                {{ number_format($product->price, 0) }}</span>
                                        @else
                                            <span class="text-xs font-bold text-slate-400">Quote on request</span>
                                        @endif
                                        <a href="{{ route('products.show', $product) }}"
                                            class="inline-flex items-center gap-1 bg-brand-600 hover:bg-brand-700 text-white text-xs font-black px-4 py-2 rounded-lg transition-colors shrink-0">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-x-6 gap-y-4">
                    ...
                    <div class="flex items-center gap-3">
                        <div class="w-9 h-9 rounded-lg bg-brand-100 flex items-center justify-center shrink-0">
                            <x-heroicon-o-truck class="w-5 h-5 text-brand-600" />
                        </div>
                        <div>
                ...
                <div class="grid sm:grid-cols-2 gap-5">
                    ...
                    <a href="{{ route('products.index') }}"
                        ...
                        <div class="absolute inset-0 p-8 flex flex-col justify-end">
                            <span
                                class="inline-block bg-brand-600 text-white text-xs font-black uppercase tracking-widest px-3 py-1.5 rounded-full mb-3 w-fit">
                                Custom Printing
                            </span>
        ...
        {{-- ===== SPECIALIST SERVICES ===== --}}
        <section class="pb-section bg-gradient-to-b from-brand-50 to-brand-100/60 text-slate-900">
            <div class="pb-container">

                <div class="text-center mb-12">
                    <p class="pb-eyebrow mb-3">Specialist Capability</p>
                    <h2 class="pb-display text-3xl sm:text-4xl">Advanced print tech, available now.</h2>
                    <p class="text-slate-600 mt-3 max-w-xl mx-auto">We go beyond standard printing. These specialist services
                ...
                <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
                    ...
                    <div class="group relative rounded-2xl overflow-hidden h-80">
                        ...
                        <div
                            class="absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-black/10 group-hover:from-brand-950/95 group-hover:via-brand-900/60 transition-all duration-500">
                        </div>
                        <div class="absolute inset-0 p-6 flex flex-col justify-end">
                            ...
                            <a href="{{ route('services.index') }}"
                                class="text-sm font-black text-brand-400 group-hover:text-white flex items-center gap-1 hover:gap-2 transition-all">
        ...
        <section class="py-20 lg:py-28 bg-white overflow-hidden">
            <div class="md:w-[80%] mx-auto px-4 sm:px-6 lg:px-8">
                <div class="gap-14 lg:gap-20 items-center">
                    ...
                    <div>
                        <p class="text-center mb-4"><span class="pb-eyebrow">Why Printbuka</span></p>
                        <h2
                            class="text-3xl text-center sm:text-4xl mx-auto lg:text-5xl font-black text-slate-950 leading-tight mb-4">
                            Print smarter with<br>Nigeria's most trusted<br><span class="pb-display-italic text-3xl sm:text-4xl lg:text-5xl">print shop.</span>
                        </h2>
                        ...
                        <div class="grid sm:grid-cols-2 gap-5">
                            <div
                                class="flex gap-4 p-5 rounded-2xl border border-slate-100 bg-slate-50 hover:border-brand-200 hover:bg-brand-50/50 transition-colors">
                                <div class="w-12 h-12 rounded-xl bg-brand-100 flex items-center justify-center shrink-0">
                                    <x-heroicon-o-document-check class="w-6 h-6 text-brand-600" />
                                </div>
                                <div>
        ...
        <section class="py-20 bg-white">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-10">
                    <div>
                        <p class="pb-eyebrow mb-2">Browse By Category</p>
                        <h2 class="pb-display text-3xl sm:text-4xl">Everything you need to print,<br
                    ...
                    <div class="flex items-center gap-3 shrink-0">
                        ...
                        <a href="{{ route('categories.index') }}"
                            class="inline-flex items-center gap-1.5 border border-slate-200 hover:border-brand-400 hover:text-brand-700 hover:bg-brand-50 text-sm font-black px-5 py-2.5 rounded-xl transition-colors">
                            ...
                            <div id="cat-track" class="flex gap-6 transition-transform duration-500">
                                @foreach($catItems as $category)
                                    ...
                                    <a href="{{ route('products.category', $category) }}"
                                        class="cat-slide group flex-shrink-0 rounded-3xl overflow-hidden border border-slate-100 hover:border-brand-200 hover:shadow-xl transition-all duration-300 bg-white flex flex-col w-[calc(33.333%_-_16px)]">
                                        ...
                                        <div class="p-5 flex-1 flex flex-col">
                                            <div class="flex items-center justify-between mb-2">
                                                <span
                                                    class="text-xs font-black uppercase tracking-wide text-brand-600">{{ $category->tag ?: 'Category' }}</span>
                                                <span
                                            ...
                                            @endif
                                            <div
                                                class="mt-4 flex items-center gap-1 text-sm font-black text-brand-600 group-hover:gap-2 transition-all">
        ...
        <section class="py-20 bg-white">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-12">
                    <p class="pb-eyebrow mb-2">Customer Stories</p>
                    <h2 class="pb-display text-3xl sm:text-4xl">Trusted by businesses across Nigeria.</h2>
                    <p class="text-slate-500 mt-3">Real feedback from clients who order with us regularly.</p>
                </div>
                <div class="grid sm:grid-cols-3 gap-6">
                    <div
                        class="rounded-3xl bg-slate-50 border border-slate-100 p-7 hover:border-brand-200 hover:shadow-md transition-all">
                        ...
                        <div class="flex items-center gap-3 mt-6 pt-5 border-t border-slate-200">
                            <div class="w-10 h-10 rounded-full bg-brand-100 flex items-center justify-center shrink-0">
                                <span class="text-xs font-black text-brand-700">KG</span>
                            </div>
                            <div>
        ...
        @if(($popularGiftItems ?? collect())->isNotEmpty())
            <section class="py-20 bg-slate-50">
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-10">
                        <div>
                            <p class="pb-eyebrow mb-2">Gift-Ready</p>
                            <h2 class="pb-display text-3xl sm:text-4xl">Most popular gift-ready products.</h2>
                        </div>
                        <a href="{{ route('products.index') }}" class="pb-cta-outline hover:border-amber-400 hover:text-amber-700 hover:bg-amber-50 shrink-0">
        ...
        @if(($featuredShopProducts ?? collect())->isNotEmpty())
            <section class="py-20 bg-white border-t border-slate-100">
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-10">
                        <div>
                            <p class="pb-eyebrow mb-2">Instant Checkout</p>
                            <h2 class="pb-display text-3xl sm:text-4xl">Ready-to-buy products.<br
                                    class="hidden lg:block"> <span class="pb-display-italic text-3xl sm:text-4xl">No quote needed.</span></h2>
                            <p class="text-slate-500 mt-3 max-w-xl">Fixed prices, instant checkout. Pay securely via Paystack —
                                delivered to your door.</p>
                        </div>
                        <a href="{{ route('shop.index') }}"
                            class="inline-flex items-center gap-1.5 border border-slate-200 hover:border-brand-400 hover:text-brand-700 hover:bg-brand-50 text-sm font-black px-5 py-2.5 rounded-xl transition-colors shrink-0">
                        ...
                        @foreach($featuredShopProducts as $shopProduct)
                            <article
                                ...
                                <div class="h-48 overflow-hidden bg-slate-100 relative shrink-0">
                                    ...
                                    @if($shopProduct->isOnSale())
                                        <div class="absolute top-3 left-3">
                                            <span class="text-xs font-black text-white bg-brand-600 px-2 py-1 rounded-lg">Sale</span>
                                        </div>
                                    @endif
                                ...
                                <div class="p-5 flex-1 flex flex-col">
                                    ...
                                    <div class="mt-4">
                                        <a href="{{ route('shop.show', $shopProduct) }}"
                                            class="inline-flex items-center justify-center gap-2 w-full bg-brand-600 hover:bg-brand-700 text-white text-sm font-black px-4 py-2.5 rounded-xl transition-colors">
        ...
        <section class="py-20 bg-slate-950 text-white relative overflow-hidden">
            <div class="pointer-events-none absolute inset-0">
                <div class="absolute top-0 left-1/4 w-96 h-96 rounded-full bg-brand-600/5 blur-3xl"></div>
                <div class="absolute bottom-0 right-1/4 w-96 h-96 rounded-full bg-cyan-600/5 blur-3xl"></div>
            </div>
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
                <div class="text-center mb-14">
                    <p class="pb-eyebrow mb-2 text-brand-400">How It Works</p>
                    <h2 class="pb-display text-3xl sm:text-4xl text-white">Order in 3 simple steps.</h2>
                ...
                <div class="grid sm:grid-cols-3 gap-5">
                    <div
                        class="rounded-3xl bg-white/5 border border-white/10 p-7 hover:bg-white/8 hover:border-brand-600/40 transition-all">
                        <div class="w-14 h-14 rounded-2xl bg-brand-600 flex items-center justify-center mb-6">
                ...
                <div class="flex flex-wrap justify-center gap-3 mt-10">
                    <a href="{{ route('orders.track') }}" class="pb-cta border border-white/20 text-white hover:bg-white hover:text-slate-950">Track an Order</a>
        ...
        <section class="py-20 bg-white">
            <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
                <div
                    ...
                    <div class="pointer-events-none absolute inset-0">
                        <div
                            class="absolute top-0 right-0 w-80 h-80 rounded-full bg-brand-600/10 -translate-y-1/2 translate-x-1/3 blur-2xl">
                        </div>
                        <div
                    ...
                    <div class="relative">
                        <p class="pb-eyebrow mb-3 text-brand-400">Get Started</p>
                        <h2 class="pb-display text-4xl lg:text-5xl text-white mb-4">Ready to start printing?</h2>
                        ...
                        <div class="flex flex-wrap justify-center gap-3">
                            <a href="{{ route('register') }}" class="pb-cta-primary h-12 px-8 text-base">Create Free Account</a>
                            <a href="{{ route('products.index') }}" class="pb-cta border border-white/25 text-white hover:bg-white/10 h-12 px-8 text-base">Browse Products</a>
                        </div>
                    </div>
                </div>
            </div>
