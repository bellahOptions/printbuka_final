        ...
        <div class="lg:flex lg:min-h-screen">
            ...
            <aside id="pb-sidebar"
                ...
                <div id="pb-sidebar-body" class="flex flex-1 flex-col overflow-y-auto px-3 py-4 gap-0.5">
                    ...
                    @if($admin?->canAdmin('pricelist.manage'))
                        <a href="{{ route('admin.pricelist.index') }}" class="{{ $navLink('admin.pricelist.*') }}">
                            <svg class="pb-nav-icon h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
                    ...
                    @if($admin?->canAdmin('staff.queries'))
                        <a href="{{ route('admin.staff-queries.index') }}" class="{{ $navLink('admin.staff-queries.*') }}">
                            <svg class="pb-nav-icon h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    @if($admin?->canAdmin('staff.evaluations'))
                        <a href="{{ route('admin.evaluations.index') }}" class="{{ $navLink('admin.evaluations.*') }}">
                            <svg class="pb-nav-icon h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    @if($admin?->canAdmin('payroll.view'))
                        <a href="{{ route('admin.payroll.index') }}" class="{{ $navLink('admin.payroll.*') }}">
                            <svg class="pb-nav-icon h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    @if($admin?->canAdmin('*'))
                        ...
                        @if($admin?->role === 'super_admin')
                            ...
                            <a href="{{ route('admin.pdf-templates.index') }}" class="{{ $navLink('admin.pdf-templates.*') }}">
                                <svg class="pb-nav-icon h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
