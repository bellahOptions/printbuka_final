...
@section('title', 'Phase Alert')
@section('headerBadge', 'PHASE NOTIFICATION')
@section('headerTitle', 'A Job Has Entered Your Phase')
@section('headerSubtitle', 'Order '.($order->job_order_number ?? $order->displayNumber()).' is now in '.$phaseName.'.')
