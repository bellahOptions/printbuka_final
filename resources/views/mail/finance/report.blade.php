...
@section('title', 'Printbuka Finance Report')
@section('headerBadge', 'FINANCIAL REPORT')
@section('headerTitle', $periodLabel.' Report')
@section('headerSubtitle', 'Generated '.now()->format('F j, Y').' · Printbuka')
