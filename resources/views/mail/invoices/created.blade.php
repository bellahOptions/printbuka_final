                ...
                <td align="center">
                    <table role="presentation" width="640" cellpadding="0" cellspacing="0" style="max-width:640px;background:#ffffff;border-radius:10px;overflow:hidden;" class="email-card">
                        @include('mail.partials.header', [
                            'headerBadge' => $documentType,
                            'headerTitle' => 'Your Printbuka '.$documentTypeLower.' is ready',
                            'headerSubtitle' => $documentType.' '.$invoice->invoice_number.' for order '.($invoice->order->job_order_number ?? $invoice->order->displayNumber()).' is attached as a PDF.',
                        ])
                        <tr>
